...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.gif=QMovie("/Users/armanahmed/Downloads/minor2/static/picture.gif")
...
"}")
    ...
    def upload_image(self):
        ...
        path=str(path)
        print(path)
        model=load_model('/Users/armanahmed/Downloads/minor2/models/model1.h5')
    ...
    def predict_result(self):
        ...
        if result[0][0]>0.5:
            ...
            subprocess.call(["say", "Result is Normal"])


        else:
            print("Affected By PNEUMONIA")
            subprocess.call(["say", "Affected By PNEUMONIA"])
